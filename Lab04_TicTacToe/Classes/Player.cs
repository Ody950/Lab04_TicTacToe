...
namespace Lab04_TicTacToe.Classes
{
    public class Player
    {
        ...
        /// </summary>
        /// <param name="board">Get the Position the player want to select</param>
        /// 
        ...
        /// <summary>
        /// switch statement to return the corresponding Position object based on the value of the position
        /// </summary>
        /// <param name="position">location in the board</param>
        /// 
